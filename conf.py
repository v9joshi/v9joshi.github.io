...
BLOG_TITLE = "Varun Joshi"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://v9joshi.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://v9joshi.github.io/"
BLOG_EMAIL = "v9joshi@gmail.com"
BLOG_DESCRIPTION = "This is my personal website."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/index.html", "About Me"),
	("/graduate-research/index.html", "Graduate Research"),
    ),
}
...
# Avoiding conflixts in index generation
INDEX_PATH = "blog"
...
RSS_COPYRIGHT = 'Contents © <a href="mailto:{email}">{author}</a> {license}'
RSS_COPYRIGHT_PLAIN = 'Contents © {author} {license}'
...
GLOBAL_CONTEXT = {}
#GLOBAL_CONTEXT.update({'subtheme': 'sky', 'transition': 'none'}) # only for reveal
